...
class Fu1 extends StatelessWidget {
  const Fu1({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  subtitle: 'Array is a collection of elements of the same type placed in contiguous memory locations',
                  page: Arr(), // Replace with your Array page
                ),
                  _buildAlgorithmTile(
                    context,
                    icon: Icons.arrow_right,
                    title: 'Linked List Implementation',
                    subtitle: 'By using pointers, we can implement linked lists',
                    page: Link(),
                  ),
