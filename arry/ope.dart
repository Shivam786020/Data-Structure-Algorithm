...
class Ope extends StatelessWidget {
  const Ope({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                _buildAlgorithmTile(
                  ...
                  title: 'Searching',
                  subtitle: 'Read About Linear Search,Binary Search',
                  page: Searching(), // Replace with your Array page
                ),
          _buildAlgorithmTile(
                  context,
                  icon: Icons.arrow_right,
                  title: 'Sorting',
                  subtitle: 'Read About Sorting Techniques',
                  page: Sort(), // Replace with your Array page
                ),
              ],
            ),
          ),
